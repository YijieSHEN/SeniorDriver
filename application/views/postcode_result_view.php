...
<div class="container marketing" style="background-color: #DCDCDC; padding-top: 15px; padding-bottom: 15px; border-radius: 5px;">
      <div class="row">
        <div class="span3">
        ...
        <div class="span3">
               <p class="text-center"><a class="btn" href="<?php echo base_url($details_link); ?>">View details &raquo;</a></p>
        </div>
      </div>
   </div>
<br/>
...
<div class="container marketing" >
      <div class="row">
        <div class="span6" style="background-color: #F5F5F5; padding-top: 10px; padding-bottom: 10px; border-radius: 5px;">
          ...
          <p class="text-center">Compares the total crash of a suburb to the average crash rate for a suburb in Victoria.</p>
        </div>
        <div class="span6" style="background-color: #F5F5F5; padding-top: 10px; padding-bottom: 10px; border-radius: 5px;">
...
<div class="container marketing">
      <div class="row">
        <div class="span6" style="background-color: #F5F5F5; padding-top: 15px; padding-bottom: 15px; border-radius: 5px;">
          ...
          <h2 class="text-center">Period</h2>
