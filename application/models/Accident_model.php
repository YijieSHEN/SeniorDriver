...
class Accident_model extends CI_Model {
	...
	public function get_accident_by_postcode($input_postcode){
        ...
        public function get_accident_by_date($input_postcode, $search_date){
                $query = $this->db->query("Select * from Accident a, Person b, Accident_Details c where  a.ACCIDENT_NO = b.ACCIDENT_NO and a.ACCIDENT_NO = c.ACCIDENT_NO and b.Age > 65 and a.Postcode_No = $input_postcode and c.Accident_Date LIKE '$search_date' and Road_User_Type='Drivers'");
